...
const MONGO_URI = 'mongodb+srv://kamoazmiu:MyStrongPass123@kamoazmiu.rooymnz.mongodb.net/KamoAzmiuDB?appName=KamoAzmiu';
...
app.post('/order', async (req, res) => {
  try {
    ...
    // MongoDB-yə order yazılır, kontrakt ünvanları sabit istifadə olunur
    const order = await Order.create({
      tokenId: tokenId.toString(),
      price,
      nftContract: NFT_CONTRACT_ADDRESS,          // sabit ERC721A kontrakt ünvanı
      marketplaceContract: PROXY_CONTRACT_ADDRESS, // sabit Proxy/Seaport kontrakt ünvanı
